...
unsigned char *unbase64(char *input, int length)
{
        ...
        //Dekodowanie za pomocą Qt
        //unsigned char *bufferQt;
        //QByteArray arg1(input, length);
        //arg1 = QByteArray::fromBase64(arg1);
        //bufferQt = reinterpret_cast<unsigned char*>(arg1.data());

        //Wyświetlenie hexów zdekodowanych wyżej
        //qDebug() << QByteArray(reinterpret_cast<char*>(buffer)).toHex().data();
        //qDebug() << QByteArray(reinterpret_cast<char*>(bufferQt)).toHex().data()
